...
static void help(char** argv)
{
    cout << "\nThis program demonstrats keypoint finding and matching between 2 images using features2d framework.\n"
     ...
     << "Example of case2:\n"
     << "./descriptor_extractor_matcher SURF SURF BruteForce CrossCheckFilter d:\\picture\\121.jpg d:\\picture\\212.jpg 3\n"
     << "\n"
...
int main(int argc, char** argv)
{
    ...
    Mat img1 = imread( "d:\\picture\\messi13.jpg" );
    Mat img2 = imread( "d:\\picture\\messi12.jpg");
    cout << ">" << endl;
